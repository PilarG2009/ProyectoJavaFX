...
public class Persona {
    ...
    public Persona(String linea) {
        ...
        this.disenyo = elementos[7].equals("true");
    ...
    public String modelo2Fichero() {
        return dni+";"+ nombre+";"+telefono+";"+sexo+";"+fechaNacimiento.toString()+";"+ocupacion+";"+tecnologia+";"+disenyo+";"+consultoria+";"+formacion+";"+imagen;
    }
}
